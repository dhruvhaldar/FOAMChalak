 ...
 */ export async function generateSlices(options = {}) {
    ...
    try {
        ...
        if (!range) {
            const rangeMinInput = document.getElementById('slice_rangeMin');
            const rangeMaxInput = document.getElementById('slice_rangeMax');
 ...
 */ export async function loadSliceMesh(vtkFilePath) {
    if (!vtkFilePath) {
        if (typeof showNotification === 'function') {
 ...
 */ async function fetchSlices(requestData) {
 ...
 */ function displaySliceVisualization(container, content) {
    if (!container) {
 ...
 */ function handleSliceError(placeholder, viewer, error) {
 ...
 */ function updateRangeInputs(fieldName) {
    ...
    if (min !== undefined && max !== undefined) {
        const minInput = document.getElementById('slice_rangeMin');
        const maxInput = document.getElementById('slice_rangeMax');
